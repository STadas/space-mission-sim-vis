 ...
 *			program.
 *		- Make set_viewpoint_* and get_image methods return PanguResponse enum
 *		- Add *&img argument to get_image as a means of acquiring the image data
 *			pointer.
 *   {add_changes_here}
 *
 * Future work:
...
extern PanguResponse pan_protocol_start(SOCKET);
	/*
...
extern PanguResponse pan_protocol_get_image(SOCKET, unsigned long *psize, unsigned char *&img);
	/*
...
extern PanguResponse pan_protocol_set_viewpoint_by_degrees_s(SOCKET, float, float, float, float, float, float);
	/*
...
extern PanguResponse pan_protocol_set_viewpoint_by_angle(SOCKET, float, float, float, float, float, float);
	/*
	 * Backwards compatibility.
	 *
...
extern PanguResponse pan_protocol_set_viewpoint_by_angle_s(SOCKET, float, float, float, float, float, float rl);
	/*
	 * Backwards compatibility.
	 *
...
extern PanguResponse pan_protocol_set_viewpoint_by_quaternion_s(SOCKET, float, float, float, float, float, float, float);
	/*
...
extern PanguResponse pan_protocol_set_viewpoint_by_quaternion(SOCKET, float, float, float, float, float, float, float);
	/*
	 * Backwards compatibility.
	 *
...
extern PanguResponse pan_protocol_set_viewpoint_by_degrees_d(SOCKET, double, double, double, double, double, double);
	/*
...
extern PanguResponse pan_protocol_set_viewpoint_by_angle_d(SOCKET, double, double, double, double, double, double);
	/*
	 * Backwards compatibility.
	 *
...
extern PanguResponse pan_protocol_set_viewpoint_by_quaternion_d(SOCKET, double, double, double, double, double, double, double);
	/*
...
extern PanguResponse pan_protocol_set_viewpoint_by_radians(SOCKET, double, double, double, double, double, double);
	/*
