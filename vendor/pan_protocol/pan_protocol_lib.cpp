 ...
 */
void pan_protocol_start(SOCKET s) {
 ...
 * IMPLEMENTS GetImage (1)
 */
unsigned char *pan_protocol_get_image(SOCKET s, unsigned long *psize) {
  char *error = pan_net_get_image_TX(s);
  if (!error)
    return pan_net_get_image_RX(s, psize);
  (void)fprintf(stderr, "%s", error);
  (void)exit(1);
}
 ...
 * IMPLEMENTS SetViewpointByDegreesS (256)
 */
void pan_protocol_set_viewpoint_by_degrees_s(SOCKET s, float x, float y,
                                             float z, float yw, float pi,
                                             float rl) {
 ...
 */
void pan_protocol_set_viewpoint_by_angle(SOCKET s, float x, float y, float z,
                                         float yw, float pi, float rl) {
 ...
 */
void pan_protocol_set_viewpoint_by_angle_s(SOCKET s, float x, float y, float z,
                                           float yw, float pi, float rl) {
  pan_protocol_set_viewpoint_by_degrees_s(s, x, y, z, yw, pi, rl);
}
 ...
 * IMPLEMENTS SetViewpointByQuaternionS (257)
 */
void pan_protocol_set_viewpoint_by_quaternion_s(SOCKET s, float x, float y,
                                                float z, float q0, float q1,
                                                float q2, float q3) {
  char *error =
 ...
 */
void pan_protocol_set_viewpoint_by_quaternion(SOCKET s, float x, float y,
                                              float z, float q0, float q1,
                                              float q2, float q3) {
 ...
 * IMPLEMENTS SetViewpointByDegreesD (268)
 */
void pan_protocol_set_viewpoint_by_degrees_d(SOCKET s, double x, double y,
                                             double z, double yw, double pi,
                                             double rl) {
 ...
 */
void pan_protocol_set_viewpoint_by_angle_d(SOCKET s, double x, double y,
                                           double z, double yw, double pi,
                                           double rl) {
 ...
 * IMPLEMENTS SetViewpointByQuaternionD (269)
 */
void pan_protocol_set_viewpoint_by_quaternion_d(SOCKET s, double x, double y,
                                                double z, double q0, double q1,
                                                double q2, double q3) {
  char *error =
 ...
 * IMPLEMENTS SetViewpointByRadians (278)
 */
void pan_protocol_set_viewpoint_by_radians(SOCKET s, double x, double y,
                                           double z, double yw, double pi,
                                           double rl) {
